...
import { users, emailVerificationTokens, sessions, passwordChangeTokens, } from "@lofty/db/schema";
import { generateEmailVerificationToken, hashEmailVerificationToken, hashSessionToken, hashPassword, verifyPassword, generatePasswordChangeToken, hashPasswordChangeToken, } from "../services/auth.js";
import { sendPasswordChangeEmail, sendVerificationEmail, } from "../services/email.js";
...
export async function profileRoutes(app) {
    app.patch("/", async (request, reply) => {
        ...
        if (emailChanged && normalizedEmail) {
            ...
            const expiresAt = new Date(Date.now() + EMAIL_VERIFICATION_DURATION * 1000);
