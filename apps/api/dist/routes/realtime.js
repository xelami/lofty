...
import { addConnection, removeConnection, broadcastToDesktop, getDesktopConnections, } from "../services/realtime.js";
export async function realtimeRoutes(app) {
    await app.register(websocket);
    app.get("/:desktopId/realtime", {
        websocket: true,
        ...
        const membership = await db
            ...
            .from(desktopMembers)
            .where(and(eq(desktopMembers.desktopId, desktopId), eq(desktopMembers.userId, request.user.id)))
            .limit(1);
